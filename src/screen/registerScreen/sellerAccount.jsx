        ...
        <div className="registerInputContainer">
                <div className="regInput passForm">
                    ...
                    <div className="passwordContainer">
                        <input type="text" required className='passwordInput regInputField' />
                    </div>
                </div>
                <div className="regInput passForm">
            ...
            <div className="registerInputContainer">
                <div className="regInput passForm">
                    <span className="userEmail">Image of business location (Required)</span>
                    <div className="passwordContainer">
                        <input type="file" required className='passwordInput regInputField' />
                    </div>
                </div>
                <div className="regInput passForm">
                    <span className="userEmail">Video of business location (Optional)</span>
                    <div className="passwordContainer">
                        <input type="file"  required className='passwordInput regInputField' />
                    </div>
                </div>
            ...
            <div className="registerInputContainer">
                <div className="regInput passForm">
                    <span className="userEmail">Business registration certificate (Optional)</span>
                    <div className="passwordContainer">
                        <input type="file" required className='passwordInput regInputField' />
                    </div>
                </div>
                ...
                <form >
                    ...
                    <div className="checkboxRow">
                        ...
                        <label
                            ...
                            htmlFor="confirmId"
                        >
                            Confirm i am the one making the product not a third party/intermediary
                        </label>
                    </div>
                    <div className="checkboxRow">
                        <input type="checkbox"
