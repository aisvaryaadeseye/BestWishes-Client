               ...
               <div className="loginScreenRole">
                    <nav className='regNavbar'>
                        <div  className='customerNav' onClick={handleShowSller}> 
                            <Link to="customerLoginAccount" className='customerNav'>Customer Account</Link>
                            <div className="customerNavUnderline" style={{ display : showCustomer ? 'flex' : 'none'}}></div>
                        </div>
                        &nbsp; &nbsp;
                        <div  className='sellerNav' onClick={handleShowCustomer}>
                            <Link to="sellerLoginAccount" className='sellerNav'>Seller Account</Link>
                        <div className="sellerNavUnderline" style={{display: showSeller? 'flex' : 'none'}}></div>
